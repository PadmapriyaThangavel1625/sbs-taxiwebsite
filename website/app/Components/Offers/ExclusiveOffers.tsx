  ...
  const offers = [
    {
      ...
      code: "SBSNEW50",
      bgGradient: "bg-gradient-to-br from-[#0047ab] via-[#1e6091] to-[#184e77]",
    ...
    },
    {
      ...
      code: "SBSOUT10",
      bgGradient: "bg-gradient-to-b from-[#eef4f8] to-[#d6e2ec]",
      textColor: "text-[#0d1b2a]",
    ...
    },
    {
      ...
      bgGradient: "bg-gradient-to-b from-[#e2f6eb] to-[#c7e9d7]",
      textColor: "text-[#0d1b2a]",
  ...
  return (
    <section className="py-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-[#0d1b2a]">Exclusive Offers</h2>
        <div className="w-10 h-1 bg-[#ffb703] mx-auto mt-1.5 rounded-full"></div>
      </div>
